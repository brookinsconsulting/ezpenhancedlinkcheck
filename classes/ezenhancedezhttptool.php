...
/*!
  \class eZEnhancedHTTPTool ezenhancedhttptool.php
  \ingroup eZHTTP
...
class eZEnhancedHTTPTool
{
    /*!
     Initializes the class. Use eZEnhancedHTTPTool::instance to get a single instance.
    */
    function eZEnhancedHTTPTool()
    {
    ...
    */
    ...
    /**
     * Return a unique instance of the eZEnhancedHTTPTool class
     *
     * @return eZEnhancedHTTPTool
     */
    static function instance()
    {
        if ( !isset( $GLOBALS["eZEnhancedHTTPToolInstance"] ) ||
             !( $GLOBALS["eZEnhancedHTTPToolInstance"] instanceof eZEnhancedHTTPTool ) )
        {
            $GLOBALS["eZEnhancedHTTPToolInstance"] = new eZEnhancedHTTPTool();
            $GLOBALS["eZEnhancedHTTPToolInstance"]->createPostVarsFromImageButtons();
        }

        return $GLOBALS["eZEnhancedHTTPToolInstance"];
    }
